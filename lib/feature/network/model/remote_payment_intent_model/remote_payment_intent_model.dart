...
class RemotePaymentIntentModel {
	String? id;
	String? object;
	int? amount;
	...
	factory RemotePaymentIntentModel.fromJson(Map<String, dynamic> json) {
		return RemotePaymentIntentModel(
